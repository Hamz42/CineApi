...
{
    public class GrupoPoblacionalRepository : GenericRepository<AplicacionesGrupoPoblacional>, IGrupoPoblacionalRepository
    {
         public GrupoPoblacionalRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
        }
    }
}
