...
{
    public class IdentificacionRepository : GenericRepository<AplicacionesTipoIdentificacion>, IIdentificacionRepository
    {
        public IdentificacionRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
        } 
    }
}
