...
{
    public class DepartamentoRepository : GenericRepository<AplicacionesDepartamento>, IDepartamentoRepository
    {
        public DepartamentoRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
        }
    }
}
