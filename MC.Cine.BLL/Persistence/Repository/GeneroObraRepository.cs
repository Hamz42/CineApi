...
{
    public class GeneroObraRepository : GenericRepository<AplicacionesGeneroObra>, IGeneroObraRepository
    {
        public GeneroObraRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
        }
    } 
}
