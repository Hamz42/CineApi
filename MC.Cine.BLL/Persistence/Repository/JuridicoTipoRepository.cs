...
{
    public class JuridicoTipoRepository : GenericRepository<JuridicoTipo>, IJuridicoTipoRepository
    {
        public JuridicoTipoRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
        }
    } 
}
