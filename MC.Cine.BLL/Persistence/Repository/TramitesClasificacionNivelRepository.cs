...
{
    public class TramitesClasificacionNivelRepository : GenericRepository<TramitesClasificacionNivel>, ITramitesClasificacionNivelRepository
    {
        public TramitesClasificacionNivelRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
        }
    }
}
